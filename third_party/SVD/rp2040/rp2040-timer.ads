...
package RP2040.TIMER is
   ...
   subtype ARMED_ARMED_Field is RP2040.UInt4;
   ...
   subtype DBGPAUSE_DBG_Element is RP2040.Bit;
   ...
   subtype PAUSE_PAUSE_Field is RP2040.Bit;
   ...
   subtype INTR_ALARM_0_Field is RP2040.Bit;
   subtype INTR_ALARM_1_Field is RP2040.Bit;
   subtype INTR_ALARM_2_Field is RP2040.Bit;
   subtype INTR_ALARM_3_Field is RP2040.Bit;
   ...
   subtype INTE_ALARM_0_Field is RP2040.Bit;
   subtype INTE_ALARM_1_Field is RP2040.Bit;
   subtype INTE_ALARM_2_Field is RP2040.Bit;
   subtype INTE_ALARM_3_Field is RP2040.Bit;
   ...
   subtype INTF_ALARM_0_Field is RP2040.Bit;
   subtype INTF_ALARM_1_Field is RP2040.Bit;
   subtype INTF_ALARM_2_Field is RP2040.Bit;
   subtype INTF_ALARM_3_Field is RP2040.Bit;
   ...
   subtype INTS_ALARM_0_Field is RP2040.Bit;
   subtype INTS_ALARM_1_Field is RP2040.Bit;
   subtype INTS_ALARM_2_Field is RP2040.Bit;
   subtype INTS_ALARM_3_Field is RP2040.Bit;
   ...
   type TIMER_Peripheral is record
      ...
      TIMEHW   : aliased RP2040.UInt32;
      --  Write to bits 31:0 of time\n writes do not get copied to time until
      --  timehw is written
      TIMELW   : aliased RP2040.UInt32;
      --  Read from bits 63:32 of time\n always read timelr before timehr
      TIMEHR   : aliased RP2040.UInt32;
      --  Read from bits 31:0 of time
      TIMELR   : aliased RP2040.UInt32;
      ...
      TIMERAWH : aliased RP2040.UInt32;
      --  Raw read from bits 31:0 of time (no side effects)
      TIMERAWL : aliased RP2040.UInt32;
      --  Set bits high to enable pause when the corresponding debug ports are
      --  active
