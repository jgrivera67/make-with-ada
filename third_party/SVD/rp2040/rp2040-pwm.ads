...
package RP2040.PWM is
   ...
   subtype CH0_CSR_EN_Field is RP2040.Bit;
   subtype CH0_CSR_PH_CORRECT_Field is RP2040.Bit;
   subtype CH0_CSR_A_INV_Field is RP2040.Bit;
   subtype CH0_CSR_B_INV_Field is RP2040.Bit;
   ...
   subtype CH0_CSR_PH_RET_Field is RP2040.Bit;
   subtype CH0_CSR_PH_ADV_Field is RP2040.Bit;

   --  Control and status register
   type CH0_CSR_Register is record
      --  Enable the PWM channel.
      EN            : CH0_CSR_EN_Field := 16#0#;
      --  1: Enable phase-correct modulation. 0: Trailing-edge
      PH_CORRECT    : CH0_CSR_PH_CORRECT_Field := 16#0#;
      --  Invert output A
      A_INV         : CH0_CSR_A_INV_Field := 16#0#;
      --  Invert output B
      B_INV         : CH0_CSR_B_INV_Field := 16#0#;
      DIVMODE       : CH0_CSR_DIVMODE_Field := RP2040.PWM.div;
   ...
   subtype CH0_DIV_FRAC_Field is RP2040.UInt4;
   subtype CH0_DIV_INT_Field is RP2040.Byte;
   ...
   subtype CH0_CTR_CH0_CTR_Field is RP2040.UInt16;
   ...
   subtype CH0_CC_A_Field is RP2040.UInt16;
   subtype CH0_CC_B_Field is RP2040.UInt16;
   ...
   subtype CH0_TOP_CH0_TOP_Field is RP2040.UInt16;
   ...
   subtype CH1_CSR_EN_Field is RP2040.Bit;
   subtype CH1_CSR_PH_CORRECT_Field is RP2040.Bit;
   subtype CH1_CSR_A_INV_Field is RP2040.Bit;
   subtype CH1_CSR_B_INV_Field is RP2040.Bit;
   ...
   subtype CH1_CSR_PH_RET_Field is RP2040.Bit;
   subtype CH1_CSR_PH_ADV_Field is RP2040.Bit;

   --  Control and status register
   type CH1_CSR_Register is record
      --  Enable the PWM channel.
      EN            : CH1_CSR_EN_Field := 16#0#;
      --  1: Enable phase-correct modulation. 0: Trailing-edge
      PH_CORRECT    : CH1_CSR_PH_CORRECT_Field := 16#0#;
      --  Invert output A
      A_INV         : CH1_CSR_A_INV_Field := 16#0#;
      --  Invert output B
      B_INV         : CH1_CSR_B_INV_Field := 16#0#;
      DIVMODE       : CH1_CSR_DIVMODE_Field := RP2040.PWM.div;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Retard the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running.
      PH_RET        : CH1_CSR_PH_RET_Field := 16#0#;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Advance the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running\n at less than full speed (div_int + div_frac / 16 > 1)
      PH_ADV        : CH1_CSR_PH_ADV_Field := 16#0#;
      --  unspecified
      Reserved_8_31 : RP2040.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CH1_DIV_FRAC_Field is RP2040.UInt4;
   subtype CH1_DIV_INT_Field is RP2040.Byte;
   ...
   subtype CH1_CTR_CH1_CTR_Field is RP2040.UInt16;
   ...
   subtype CH1_CC_A_Field is RP2040.UInt16;
   subtype CH1_CC_B_Field is RP2040.UInt16;
   ...
   subtype CH1_TOP_CH1_TOP_Field is RP2040.UInt16;
   ...
   subtype CH2_CSR_EN_Field is RP2040.Bit;
   subtype CH2_CSR_PH_CORRECT_Field is RP2040.Bit;
   subtype CH2_CSR_A_INV_Field is RP2040.Bit;
   subtype CH2_CSR_B_INV_Field is RP2040.Bit;
   ...
   subtype CH2_CSR_PH_RET_Field is RP2040.Bit;
   subtype CH2_CSR_PH_ADV_Field is RP2040.Bit;

   --  Control and status register
   type CH2_CSR_Register is record
      --  Enable the PWM channel.
      EN            : CH2_CSR_EN_Field := 16#0#;
      --  1: Enable phase-correct modulation. 0: Trailing-edge
      PH_CORRECT    : CH2_CSR_PH_CORRECT_Field := 16#0#;
      --  Invert output A
      A_INV         : CH2_CSR_A_INV_Field := 16#0#;
      --  Invert output B
      B_INV         : CH2_CSR_B_INV_Field := 16#0#;
      DIVMODE       : CH2_CSR_DIVMODE_Field := RP2040.PWM.div;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Retard the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running.
      PH_RET        : CH2_CSR_PH_RET_Field := 16#0#;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Advance the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running\n at less than full speed (div_int + div_frac / 16 > 1)
      PH_ADV        : CH2_CSR_PH_ADV_Field := 16#0#;
      --  unspecified
      Reserved_8_31 : RP2040.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CH2_DIV_FRAC_Field is RP2040.UInt4;
   subtype CH2_DIV_INT_Field is RP2040.Byte;
   ...
   subtype CH2_CTR_CH2_CTR_Field is RP2040.UInt16;
   ...
   subtype CH2_CC_A_Field is RP2040.UInt16;
   subtype CH2_CC_B_Field is RP2040.UInt16;
   ...
   subtype CH2_TOP_CH2_TOP_Field is RP2040.UInt16;
   ...
   subtype CH3_CSR_EN_Field is RP2040.Bit;
   subtype CH3_CSR_PH_CORRECT_Field is RP2040.Bit;
   subtype CH3_CSR_A_INV_Field is RP2040.Bit;
   subtype CH3_CSR_B_INV_Field is RP2040.Bit;
   ...
   subtype CH3_CSR_PH_RET_Field is RP2040.Bit;
   subtype CH3_CSR_PH_ADV_Field is RP2040.Bit;

   --  Control and status register
   type CH3_CSR_Register is record
      --  Enable the PWM channel.
      EN            : CH3_CSR_EN_Field := 16#0#;
      --  1: Enable phase-correct modulation. 0: Trailing-edge
      PH_CORRECT    : CH3_CSR_PH_CORRECT_Field := 16#0#;
      --  Invert output A
      A_INV         : CH3_CSR_A_INV_Field := 16#0#;
      --  Invert output B
      B_INV         : CH3_CSR_B_INV_Field := 16#0#;
      DIVMODE       : CH3_CSR_DIVMODE_Field := RP2040.PWM.div;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Retard the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running.
      PH_RET        : CH3_CSR_PH_RET_Field := 16#0#;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Advance the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running\n at less than full speed (div_int + div_frac / 16 > 1)
      PH_ADV        : CH3_CSR_PH_ADV_Field := 16#0#;
      --  unspecified
      Reserved_8_31 : RP2040.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CH3_DIV_FRAC_Field is RP2040.UInt4;
   subtype CH3_DIV_INT_Field is RP2040.Byte;
   ...
   subtype CH3_CTR_CH3_CTR_Field is RP2040.UInt16;
   ...
   subtype CH3_CC_A_Field is RP2040.UInt16;
   subtype CH3_CC_B_Field is RP2040.UInt16;
   ...
   subtype CH3_TOP_CH3_TOP_Field is RP2040.UInt16;
   ...
   subtype CH4_CSR_EN_Field is RP2040.Bit;
   subtype CH4_CSR_PH_CORRECT_Field is RP2040.Bit;
   subtype CH4_CSR_A_INV_Field is RP2040.Bit;
   subtype CH4_CSR_B_INV_Field is RP2040.Bit;
   ...
   subtype CH4_CSR_PH_RET_Field is RP2040.Bit;
   subtype CH4_CSR_PH_ADV_Field is RP2040.Bit;

   --  Control and status register
   type CH4_CSR_Register is record
      --  Enable the PWM channel.
      EN            : CH4_CSR_EN_Field := 16#0#;
      --  1: Enable phase-correct modulation. 0: Trailing-edge
      PH_CORRECT    : CH4_CSR_PH_CORRECT_Field := 16#0#;
      --  Invert output A
      A_INV         : CH4_CSR_A_INV_Field := 16#0#;
      --  Invert output B
      B_INV         : CH4_CSR_B_INV_Field := 16#0#;
      DIVMODE       : CH4_CSR_DIVMODE_Field := RP2040.PWM.div;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Retard the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running.
      PH_RET        : CH4_CSR_PH_RET_Field := 16#0#;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Advance the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running\n at less than full speed (div_int + div_frac / 16 > 1)
      PH_ADV        : CH4_CSR_PH_ADV_Field := 16#0#;
      --  unspecified
      Reserved_8_31 : RP2040.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CH4_DIV_FRAC_Field is RP2040.UInt4;
   subtype CH4_DIV_INT_Field is RP2040.Byte;
   ...
   subtype CH4_CTR_CH4_CTR_Field is RP2040.UInt16;
   ...
   subtype CH4_CC_A_Field is RP2040.UInt16;
   subtype CH4_CC_B_Field is RP2040.UInt16;
   ...
   subtype CH4_TOP_CH4_TOP_Field is RP2040.UInt16;
   ...
   subtype CH5_CSR_EN_Field is RP2040.Bit;
   subtype CH5_CSR_PH_CORRECT_Field is RP2040.Bit;
   subtype CH5_CSR_A_INV_Field is RP2040.Bit;
   subtype CH5_CSR_B_INV_Field is RP2040.Bit;
   ...
   subtype CH5_CSR_PH_RET_Field is RP2040.Bit;
   subtype CH5_CSR_PH_ADV_Field is RP2040.Bit;

   --  Control and status register
   type CH5_CSR_Register is record
      --  Enable the PWM channel.
      EN            : CH5_CSR_EN_Field := 16#0#;
      --  1: Enable phase-correct modulation. 0: Trailing-edge
      PH_CORRECT    : CH5_CSR_PH_CORRECT_Field := 16#0#;
      --  Invert output A
      A_INV         : CH5_CSR_A_INV_Field := 16#0#;
      --  Invert output B
      B_INV         : CH5_CSR_B_INV_Field := 16#0#;
      DIVMODE       : CH5_CSR_DIVMODE_Field := RP2040.PWM.div;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Retard the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running.
      PH_RET        : CH5_CSR_PH_RET_Field := 16#0#;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Advance the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running\n at less than full speed (div_int + div_frac / 16 > 1)
      PH_ADV        : CH5_CSR_PH_ADV_Field := 16#0#;
      --  unspecified
      Reserved_8_31 : RP2040.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CH5_DIV_FRAC_Field is RP2040.UInt4;
   subtype CH5_DIV_INT_Field is RP2040.Byte;
   ...
   subtype CH5_CTR_CH5_CTR_Field is RP2040.UInt16;
   ...
   subtype CH5_CC_A_Field is RP2040.UInt16;
   subtype CH5_CC_B_Field is RP2040.UInt16;
   ...
   subtype CH5_TOP_CH5_TOP_Field is RP2040.UInt16;
   ...
   subtype CH6_CSR_EN_Field is RP2040.Bit;
   subtype CH6_CSR_PH_CORRECT_Field is RP2040.Bit;
   subtype CH6_CSR_A_INV_Field is RP2040.Bit;
   subtype CH6_CSR_B_INV_Field is RP2040.Bit;
   ...
   subtype CH6_CSR_PH_RET_Field is RP2040.Bit;
   subtype CH6_CSR_PH_ADV_Field is RP2040.Bit;

   --  Control and status register
   type CH6_CSR_Register is record
      --  Enable the PWM channel.
      EN            : CH6_CSR_EN_Field := 16#0#;
      --  1: Enable phase-correct modulation. 0: Trailing-edge
      PH_CORRECT    : CH6_CSR_PH_CORRECT_Field := 16#0#;
      --  Invert output A
      A_INV         : CH6_CSR_A_INV_Field := 16#0#;
      --  Invert output B
      B_INV         : CH6_CSR_B_INV_Field := 16#0#;
      DIVMODE       : CH6_CSR_DIVMODE_Field := RP2040.PWM.div;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Retard the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running.
      PH_RET        : CH6_CSR_PH_RET_Field := 16#0#;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Advance the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running\n at less than full speed (div_int + div_frac / 16 > 1)
      PH_ADV        : CH6_CSR_PH_ADV_Field := 16#0#;
      --  unspecified
      Reserved_8_31 : RP2040.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CH6_DIV_FRAC_Field is RP2040.UInt4;
   subtype CH6_DIV_INT_Field is RP2040.Byte;
   ...
   subtype CH6_CTR_CH6_CTR_Field is RP2040.UInt16;
   ...
   subtype CH6_CC_A_Field is RP2040.UInt16;
   subtype CH6_CC_B_Field is RP2040.UInt16;
   ...
   subtype CH6_TOP_CH6_TOP_Field is RP2040.UInt16;
   ...
   subtype CH7_CSR_EN_Field is RP2040.Bit;
   subtype CH7_CSR_PH_CORRECT_Field is RP2040.Bit;
   subtype CH7_CSR_A_INV_Field is RP2040.Bit;
   subtype CH7_CSR_B_INV_Field is RP2040.Bit;
   ...
   subtype CH7_CSR_PH_RET_Field is RP2040.Bit;
   subtype CH7_CSR_PH_ADV_Field is RP2040.Bit;

   --  Control and status register
   type CH7_CSR_Register is record
      --  Enable the PWM channel.
      EN            : CH7_CSR_EN_Field := 16#0#;
      --  1: Enable phase-correct modulation. 0: Trailing-edge
      PH_CORRECT    : CH7_CSR_PH_CORRECT_Field := 16#0#;
      --  Invert output A
      A_INV         : CH7_CSR_A_INV_Field := 16#0#;
      --  Invert output B
      B_INV         : CH7_CSR_B_INV_Field := 16#0#;
      DIVMODE       : CH7_CSR_DIVMODE_Field := RP2040.PWM.div;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Retard the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running.
      PH_RET        : CH7_CSR_PH_RET_Field := 16#0#;
      --  After a write operation all bits in the field are cleared (set to
      --  zero). Advance the phase of the counter by 1 count, while it is
      --  running.\n Self-clearing. Write a 1, and poll until low. Counter must
      --  be running\n at less than full speed (div_int + div_frac / 16 > 1)
      PH_ADV        : CH7_CSR_PH_ADV_Field := 16#0#;
      --  unspecified
      Reserved_8_31 : RP2040.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CH7_DIV_FRAC_Field is RP2040.UInt4;
   subtype CH7_DIV_INT_Field is RP2040.Byte;
   ...
   subtype CH7_CTR_CH7_CTR_Field is RP2040.UInt16;
   ...
   subtype CH7_CC_A_Field is RP2040.UInt16;
   subtype CH7_CC_B_Field is RP2040.UInt16;
   ...
   subtype CH7_TOP_CH7_TOP_Field is RP2040.UInt16;
   ...
   --  EN_CH array element
   subtype EN_CH_Element is RP2040.Bit;

   --  EN_CH array
   type EN_CH_Field_Array is array (0 .. 7) of EN_CH_Element
   ...
   --  INTR_CH array element
   subtype INTR_CH_Element is RP2040.Bit;

   --  INTR_CH array
   type INTR_CH_Field_Array is array (0 .. 7) of INTR_CH_Element
     with Component_Size => 1, Size => 8;
   ...
   --  INTE_CH array element
   subtype INTE_CH_Element is RP2040.Bit;

   --  INTE_CH array
   type INTE_CH_Field_Array is array (0 .. 7) of INTE_CH_Element
     with Component_Size => 1, Size => 8;
   ...
   --  INTF_CH array element
   subtype INTF_CH_Element is RP2040.Bit;

   --  INTF_CH array
   type INTF_CH_Field_Array is array (0 .. 7) of INTF_CH_Element
     with Component_Size => 1, Size => 8;
   ...
   --  INTS_CH array element
   subtype INTS_CH_Element is RP2040.Bit;

   --  INTS_CH array
   type INTS_CH_Field_Array is array (0 .. 7) of INTS_CH_Element
     with Component_Size => 1, Size => 8;
