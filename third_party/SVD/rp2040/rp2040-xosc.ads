...
package RP2040.XOSC with No_Elaboration_Code_All is
   ...
   type STATUS_Register is record
      ...
      FREQ_RANGE     : STATUS_FREQ_RANGE_Field := RP2040.XOSC.Val_1_15MHZ;
      --  unspecified
      Reserved_2_11  : RP2040.UInt10 := 16#0#;
      --  Read-only. Oscillator is enabled but not necessarily running and
      --  stable, resets to 0
      ENABLED        : STATUS_ENABLED_Field := 16#0#;
      --  unspecified
      Reserved_13_23 : RP2040.UInt11 := 16#0#;
   ...
   subtype STARTUP_DELAY_Field is RP2040.UInt14;
   subtype STARTUP_X4_Field is RP2040.Bit;
   ...
   type STARTUP_Register is record
      ...
      --  unspecified
      Reserved_14_19 : RP2040.UInt6 := 16#0#;
