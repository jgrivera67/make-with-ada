...
package RP2040.CLOCKS with No_Elaboration_Code_All is
   ...
   subtype CLK_GPOUT0_CTRL_KILL_Field is RP2040.Bit;
   subtype CLK_GPOUT0_CTRL_ENABLE_Field is RP2040.Bit;
   subtype CLK_GPOUT0_CTRL_DC50_Field is RP2040.Bit;
   subtype CLK_GPOUT0_CTRL_PHASE_Field is RP2040.UInt2;
   subtype CLK_GPOUT0_CTRL_NUDGE_Field is RP2040.Bit;

   --  Clock control, can be changed on-the-fly (except for auxsrc)
   type CLK_GPOUT0_CTRL_Register is record
      --  unspecified
      Reserved_0_4   : RP2040.UInt5 := 16#0#;
      --  Selects the auxiliary clock source, will glitch when switching
      AUXSRC         : CLK_GPOUT0_CTRL_AUXSRC_Field :=
                        RP2040.CLOCKS.clksrc_pll_sys;
      --  unspecified
      Reserved_9_9   : RP2040.Bit := 16#0#;
   ...
   subtype CLK_GPOUT0_DIV_FRAC_Field is RP2040.Byte;
   subtype CLK_GPOUT0_DIV_INT_Field is RP2040.UInt24;
   ...
   subtype CLK_GPOUT1_CTRL_KILL_Field is RP2040.Bit;
   subtype CLK_GPOUT1_CTRL_ENABLE_Field is RP2040.Bit;
   subtype CLK_GPOUT1_CTRL_DC50_Field is RP2040.Bit;
   subtype CLK_GPOUT1_CTRL_PHASE_Field is RP2040.UInt2;
   subtype CLK_GPOUT1_CTRL_NUDGE_Field is RP2040.Bit;
   ...
   subtype CLK_GPOUT1_DIV_FRAC_Field is RP2040.Byte;
   subtype CLK_GPOUT1_DIV_INT_Field is RP2040.UInt24;
   ...
   subtype CLK_GPOUT2_CTRL_KILL_Field is RP2040.Bit;
   subtype CLK_GPOUT2_CTRL_ENABLE_Field is RP2040.Bit;
   subtype CLK_GPOUT2_CTRL_DC50_Field is RP2040.Bit;
   subtype CLK_GPOUT2_CTRL_PHASE_Field is RP2040.UInt2;
   subtype CLK_GPOUT2_CTRL_NUDGE_Field is RP2040.Bit;
   ...
   subtype CLK_GPOUT2_DIV_FRAC_Field is RP2040.Byte;
   subtype CLK_GPOUT2_DIV_INT_Field is RP2040.UInt24;
   ...
   subtype CLK_GPOUT3_CTRL_KILL_Field is RP2040.Bit;
   subtype CLK_GPOUT3_CTRL_ENABLE_Field is RP2040.Bit;
   subtype CLK_GPOUT3_CTRL_DC50_Field is RP2040.Bit;
   subtype CLK_GPOUT3_CTRL_PHASE_Field is RP2040.UInt2;
   subtype CLK_GPOUT3_CTRL_NUDGE_Field is RP2040.Bit;
   ...
   subtype CLK_GPOUT3_DIV_FRAC_Field is RP2040.Byte;
   subtype CLK_GPOUT3_DIV_INT_Field is RP2040.UInt24;
   ...
   type CLK_REF_CTRL_Register is record
      --  Selects the clock source glitchlessly, can be changed on-the-fly
      SRC           : CLK_REF_CTRL_SRC_Field := RP2040.CLOCKS.rosc_clksrc_ph;
      --  unspecified
      Reserved_2_4  : RP2040.UInt3 := 16#0#;
      --  Selects the auxiliary clock source, will glitch when switching
      AUXSRC        : CLK_REF_CTRL_AUXSRC_Field :=
                       RP2040.CLOCKS.clksrc_pll_usb;
      --  unspecified
      Reserved_7_31 : RP2040.UInt25 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CLK_REF_DIV_INT_Field is RP2040.UInt2;
   ...
   type CLK_REF_DIV_Register is record
      ...
      --  unspecified
      Reserved_10_31 : RP2040.UInt22 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type CLK_SYS_CTRL_Register is record
      --  Selects the clock source glitchlessly, can be changed on-the-fly
      SRC           : CLK_SYS_CTRL_SRC_Field := RP2040.CLOCKS.clk_ref;
      --  unspecified
      Reserved_1_4  : RP2040.UInt4 := 16#0#;
      --  Selects the auxiliary clock source, will glitch when switching
   ...
   subtype CLK_SYS_DIV_FRAC_Field is RP2040.Byte;
   subtype CLK_SYS_DIV_INT_Field is RP2040.UInt24;
   ...
   subtype CLK_PERI_CTRL_KILL_Field is RP2040.Bit;
   subtype CLK_PERI_CTRL_ENABLE_Field is RP2040.Bit;
   ...
   type CLK_PERI_CTRL_Register is record
      ...
      Reserved_0_4   : RP2040.UInt5 := 16#0#;
      --  Selects the auxiliary clock source, will glitch when switching
      AUXSRC         : CLK_PERI_CTRL_AUXSRC_Field := RP2040.CLOCKS.clk_sys;
      --  unspecified
      Reserved_8_9   : RP2040.UInt2 := 16#0#;
      --  Asynchronously kills the clock generator
   ...
   subtype CLK_USB_CTRL_KILL_Field is RP2040.Bit;
   subtype CLK_USB_CTRL_ENABLE_Field is RP2040.Bit;
   subtype CLK_USB_CTRL_PHASE_Field is RP2040.UInt2;
   subtype CLK_USB_CTRL_NUDGE_Field is RP2040.Bit;
   ...
   subtype CLK_USB_DIV_INT_Field is RP2040.UInt2;
   ...
   subtype CLK_ADC_CTRL_KILL_Field is RP2040.Bit;
   subtype CLK_ADC_CTRL_ENABLE_Field is RP2040.Bit;
   subtype CLK_ADC_CTRL_PHASE_Field is RP2040.UInt2;
   subtype CLK_ADC_CTRL_NUDGE_Field is RP2040.Bit;
   ...
   subtype CLK_ADC_DIV_INT_Field is RP2040.UInt2;
   ...
   subtype CLK_RTC_CTRL_KILL_Field is RP2040.Bit;
   subtype CLK_RTC_CTRL_ENABLE_Field is RP2040.Bit;
   subtype CLK_RTC_CTRL_PHASE_Field is RP2040.UInt2;
   subtype CLK_RTC_CTRL_NUDGE_Field is RP2040.Bit;
   ...
   subtype CLK_RTC_DIV_FRAC_Field is RP2040.Byte;
   subtype CLK_RTC_DIV_INT_Field is RP2040.UInt24;
   ...
   subtype CLK_SYS_RESUS_CTRL_TIMEOUT_Field is RP2040.Byte;
   subtype CLK_SYS_RESUS_CTRL_ENABLE_Field is RP2040.Bit;
   subtype CLK_SYS_RESUS_CTRL_FRCE_Field is RP2040.Bit;
   subtype CLK_SYS_RESUS_CTRL_CLEAR_Field is RP2040.Bit;
   ...
   type CLK_SYS_RESUS_CTRL_Register is record
      ...
      --  unspecified
      Reserved_9_11  : RP2040.UInt3 := 16#0#;
      ...
      --  unspecified
      Reserved_17_31 : RP2040.UInt15 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CLK_SYS_RESUS_STATUS_RESUSSED_Field is RP2040.Bit;
   ...
   subtype FC0_REF_KHZ_FC0_REF_KHZ_Field is RP2040.UInt20;
   ...
   subtype FC0_MIN_KHZ_FC0_MIN_KHZ_Field is RP2040.UInt25;
   ...
   subtype FC0_MAX_KHZ_FC0_MAX_KHZ_Field is RP2040.UInt25;
   ...
   subtype FC0_DELAY_FC0_DELAY_Field is RP2040.UInt3;
   ...
   subtype FC0_INTERVAL_FC0_INTERVAL_Field is RP2040.UInt4;
   ...
   type FC0_SRC_Register is record
      FC0_SRC       : FC0_SRC_FC0_SRC_Field := RP2040.CLOCKS.NULL_k;
      --  unspecified
      Reserved_8_31 : RP2040.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype FC0_STATUS_PASS_Field is RP2040.Bit;
   subtype FC0_STATUS_DONE_Field is RP2040.Bit;
   subtype FC0_STATUS_RUNNING_Field is RP2040.Bit;
   subtype FC0_STATUS_WAITING_Field is RP2040.Bit;
   subtype FC0_STATUS_FAIL_Field is RP2040.Bit;
   subtype FC0_STATUS_SLOW_Field is RP2040.Bit;
   subtype FC0_STATUS_FAST_Field is RP2040.Bit;
   subtype FC0_STATUS_DIED_Field is RP2040.Bit;
   ...
   subtype FC0_RESULT_FRAC_Field is RP2040.UInt5;
   subtype FC0_RESULT_KHZ_Field is RP2040.UInt25;
   ...
   subtype WAKE_EN0_clk_sys_clocks_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_adc_adc_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_adc_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_busctrl_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_busfabric_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_dma_Field is RP2040.Bit;
   --  WAKE_EN0_clk_sys_i2c array element
   subtype WAKE_EN0_clk_sys_i2c_Element is RP2040.Bit;
   ...
   subtype WAKE_EN0_clk_sys_io_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_jtag_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_vreg_and_chip_reset_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_pads_Field is RP2040.Bit;
   --  WAKE_EN0_clk_sys_pio array element
   subtype WAKE_EN0_clk_sys_pio_Element is RP2040.Bit;
   ...
   subtype WAKE_EN0_clk_sys_pll_sys_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_pll_usb_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_psm_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_pwm_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_resets_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_rom_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_rosc_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_rtc_rtc_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_rtc_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_sio_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_peri_spi0_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_spi0_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_peri_spi1_Field is RP2040.Bit;
   subtype WAKE_EN0_clk_sys_spi1_Field is RP2040.Bit;
   --  WAKE_EN0_clk_sys_sram array element
   subtype WAKE_EN0_clk_sys_sram_Element is RP2040.Bit;
   ...
   subtype WAKE_EN1_clk_sys_sram_Element is RP2040.Bit;
   ...
   subtype WAKE_EN1_clk_sys_syscfg_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_sys_sysinfo_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_sys_tbman_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_sys_timer_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_peri_uart0_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_sys_uart0_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_peri_uart1_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_sys_uart1_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_sys_usbctrl_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_usb_usbctrl_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_sys_watchdog_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_sys_xip_Field is RP2040.Bit;
   subtype WAKE_EN1_clk_sys_xosc_Field is RP2040.Bit;
   ...
   type WAKE_EN1_Register is record
      ...
      --  unspecified
      Reserved_15_31   : RP2040.UInt17 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SLEEP_EN0_clk_sys_clocks_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_adc_adc_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_adc_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_busctrl_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_busfabric_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_dma_Field is RP2040.Bit;
   --  SLEEP_EN0_clk_sys_i2c array element
   subtype SLEEP_EN0_clk_sys_i2c_Element is RP2040.Bit;
   ...
   subtype SLEEP_EN0_clk_sys_io_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_jtag_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_vreg_and_chip_reset_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_pads_Field is RP2040.Bit;
   --  SLEEP_EN0_clk_sys_pio array element
   subtype SLEEP_EN0_clk_sys_pio_Element is RP2040.Bit;
   ...
   subtype SLEEP_EN0_clk_sys_pll_sys_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_pll_usb_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_psm_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_pwm_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_resets_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_rom_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_rosc_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_rtc_rtc_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_rtc_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_sio_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_peri_spi0_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_spi0_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_peri_spi1_Field is RP2040.Bit;
   subtype SLEEP_EN0_clk_sys_spi1_Field is RP2040.Bit;
   --  SLEEP_EN0_clk_sys_sram array element
   subtype SLEEP_EN0_clk_sys_sram_Element is RP2040.Bit;
   ...
   subtype SLEEP_EN1_clk_sys_sram_Element is RP2040.Bit;
   ...
   subtype SLEEP_EN1_clk_sys_syscfg_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_sys_sysinfo_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_sys_tbman_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_sys_timer_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_peri_uart0_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_sys_uart0_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_peri_uart1_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_sys_uart1_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_sys_usbctrl_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_usb_usbctrl_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_sys_watchdog_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_sys_xip_Field is RP2040.Bit;
   subtype SLEEP_EN1_clk_sys_xosc_Field is RP2040.Bit;
   ...
   subtype ENABLED0_clk_sys_clocks_Field is RP2040.Bit;
   subtype ENABLED0_clk_adc_adc_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_adc_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_busctrl_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_busfabric_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_dma_Field is RP2040.Bit;
   --  ENABLED0_clk_sys_i2c array element
   subtype ENABLED0_clk_sys_i2c_Element is RP2040.Bit;
   ...
   subtype ENABLED0_clk_sys_io_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_jtag_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_vreg_and_chip_reset_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_pads_Field is RP2040.Bit;
   --  ENABLED0_clk_sys_pio array element
   subtype ENABLED0_clk_sys_pio_Element is RP2040.Bit;
   ...
   subtype ENABLED0_clk_sys_pll_sys_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_pll_usb_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_psm_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_pwm_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_resets_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_rom_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_rosc_Field is RP2040.Bit;
   subtype ENABLED0_clk_rtc_rtc_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_rtc_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_sio_Field is RP2040.Bit;
   subtype ENABLED0_clk_peri_spi0_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_spi0_Field is RP2040.Bit;
   subtype ENABLED0_clk_peri_spi1_Field is RP2040.Bit;
   subtype ENABLED0_clk_sys_spi1_Field is RP2040.Bit;
   --  ENABLED0_clk_sys_sram array element
   subtype ENABLED0_clk_sys_sram_Element is RP2040.Bit;
   ...
   subtype ENABLED1_clk_sys_sram_Element is RP2040.Bit;
   ...
   subtype ENABLED1_clk_sys_syscfg_Field is RP2040.Bit;
   subtype ENABLED1_clk_sys_sysinfo_Field is RP2040.Bit;
   subtype ENABLED1_clk_sys_tbman_Field is RP2040.Bit;
   subtype ENABLED1_clk_sys_timer_Field is RP2040.Bit;
   subtype ENABLED1_clk_peri_uart0_Field is RP2040.Bit;
   subtype ENABLED1_clk_sys_uart0_Field is RP2040.Bit;
   subtype ENABLED1_clk_peri_uart1_Field is RP2040.Bit;
   subtype ENABLED1_clk_sys_uart1_Field is RP2040.Bit;
   subtype ENABLED1_clk_sys_usbctrl_Field is RP2040.Bit;
   subtype ENABLED1_clk_usb_usbctrl_Field is RP2040.Bit;
   subtype ENABLED1_clk_sys_watchdog_Field is RP2040.Bit;
   subtype ENABLED1_clk_sys_xip_Field is RP2040.Bit;
   subtype ENABLED1_clk_sys_xosc_Field is RP2040.Bit;
   ...
   subtype INTR_CLK_SYS_RESUS_Field is RP2040.Bit;
   ...
   subtype INTE_CLK_SYS_RESUS_Field is RP2040.Bit;
   ...
   subtype INTF_CLK_SYS_RESUS_Field is RP2040.Bit;
   ...
   subtype INTS_CLK_SYS_RESUS_Field is RP2040.Bit;
