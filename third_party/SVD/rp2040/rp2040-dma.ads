...
package RP2040.DMA is
   ...
   subtype CH0_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH0_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH0_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH0_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH0_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH0_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH0_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH0_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH0_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH0_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH0_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH0_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH0_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH0_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH0_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      ...
      --  RING_SEL.
      RING_SIZE      : CH0_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      ...
      --  unspecified
      Reserved_25_28 : RP2040.UInt4 := 16#0#;
   ...
   subtype CH1_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH1_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH1_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH1_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH1_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH1_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH1_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH1_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH1_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH1_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH1_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH1_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH1_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH1_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH1_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH1_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype CH2_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH2_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH2_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH2_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH2_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH2_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH2_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH2_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH2_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH2_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH2_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH2_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH2_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH2_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH2_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH2_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype CH3_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH3_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH3_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH3_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH3_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH3_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH3_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH3_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH3_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH3_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH3_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH3_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH3_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH3_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH3_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH3_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype CH4_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH4_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH4_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH4_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH4_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH4_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH4_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH4_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH4_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH4_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH4_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH4_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH4_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH4_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH4_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH4_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype CH5_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH5_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH5_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH5_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH5_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH5_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH5_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH5_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH5_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH5_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH5_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH5_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH5_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH5_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH5_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH5_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype CH6_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH6_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH6_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH6_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH6_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH6_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH6_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH6_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH6_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH6_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH6_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH6_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH6_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH6_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH6_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH6_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype CH7_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH7_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH7_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH7_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH7_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH7_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH7_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH7_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH7_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH7_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH7_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH7_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH7_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH7_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH7_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH7_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype CH8_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH8_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH8_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH8_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH8_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH8_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH8_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH8_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH8_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH8_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH8_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH8_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH8_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH8_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH8_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH8_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype CH9_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH9_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH9_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH9_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH9_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH9_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH9_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH9_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH9_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH9_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH9_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH9_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH9_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH9_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH9_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH9_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype CH10_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH10_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH10_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH10_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH10_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH10_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH10_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH10_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH10_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH10_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH10_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH10_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH10_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH10_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH10_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH10_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype CH11_CTRL_TRIG_EN_Field is RP2040.Bit;
   subtype CH11_CTRL_TRIG_HIGH_PRIORITY_Field is RP2040.Bit;
   ...
   subtype CH11_CTRL_TRIG_INCR_READ_Field is RP2040.Bit;
   subtype CH11_CTRL_TRIG_INCR_WRITE_Field is RP2040.Bit;
   ...
   subtype CH11_CTRL_TRIG_RING_SEL_Field is RP2040.Bit;
   subtype CH11_CTRL_TRIG_CHAIN_TO_Field is RP2040.UInt4;
   ...
   subtype CH11_CTRL_TRIG_IRQ_QUIET_Field is RP2040.Bit;
   subtype CH11_CTRL_TRIG_BSWAP_Field is RP2040.Bit;
   subtype CH11_CTRL_TRIG_SNIFF_EN_Field is RP2040.Bit;
   subtype CH11_CTRL_TRIG_BUSY_Field is RP2040.Bit;
   subtype CH11_CTRL_TRIG_WRITE_ERROR_Field is RP2040.Bit;
   subtype CH11_CTRL_TRIG_READ_ERROR_Field is RP2040.Bit;
   subtype CH11_CTRL_TRIG_AHB_ERROR_Field is RP2040.Bit;
   ...
   type CH11_CTRL_TRIG_Register is record
      ...
      --  Set the size of each bus transfer (byte/halfword/word). READ_ADDR and
      --  WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer.
      DATA_SIZE      : CH11_CTRL_TRIG_DATA_SIZE_Field := RP2040.DMA.SIZE_BYTE;
      --  If 1, the read address increments with each transfer. If 0, each read
      --  is directed to the same, initial address.\n\n Generally this should
      --  be disabled for peripheral-to-memory transfers.
      ...
      --  This can apply to either read or write addresses, based on value of
      --  RING_SEL.
      RING_SIZE      : CH11_CTRL_TRIG_RING_SIZE_Field := RP2040.DMA.RING_NONE;
      --  Select whether RING_SIZE applies to read or write addresses.\n If 0,
      --  read addresses are wrapped on a (1 << RING_SIZE) boundary. If 1,
      --  write addresses are wrapped.
   ...
   subtype INTR_INTR_Field is RP2040.UInt16;
   ...
   subtype INTE0_INTE0_Field is RP2040.UInt16;
   ...
   subtype INTF0_INTF0_Field is RP2040.UInt16;
   ...
   subtype INTS0_INTS0_Field is RP2040.UInt16;
   ...
   subtype INTE1_INTE1_Field is RP2040.UInt16;
   ...
   subtype INTF1_INTF1_Field is RP2040.UInt16;
   ...
   subtype INTS1_INTS1_Field is RP2040.UInt16;
   ...
   subtype TIMER_Y_Field is RP2040.UInt16;
   subtype TIMER_X_Field is RP2040.UInt16;
   ...
   subtype MULTI_CHAN_TRIGGER_MULTI_CHAN_TRIGGER_Field is RP2040.UInt16;
   ...
   subtype SNIFF_CTRL_EN_Field is RP2040.Bit;
   subtype SNIFF_CTRL_DMACH_Field is RP2040.UInt4;
   ...
   subtype SNIFF_CTRL_BSWAP_Field is RP2040.Bit;
   subtype SNIFF_CTRL_OUT_REV_Field is RP2040.Bit;
   subtype SNIFF_CTRL_OUT_INV_Field is RP2040.Bit;
   ...
   type SNIFF_CTRL_Register is record
      ...
      CALC           : SNIFF_CTRL_CALC_Field := RP2040.DMA.CRC32;
   ...
   subtype FIFO_LEVELS_TDF_LVL_Field is RP2040.Byte;
   subtype FIFO_LEVELS_WAF_LVL_Field is RP2040.Byte;
   subtype FIFO_LEVELS_RAF_LVL_Field is RP2040.Byte;
   ...
   subtype CHAN_ABORT_CHAN_ABORT_Field is RP2040.UInt16;
   ...
   subtype N_CHANNELS_N_CHANNELS_Field is RP2040.UInt5;
   ...
   subtype CH0_DBG_CTDREQ_CH0_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH1_DBG_CTDREQ_CH1_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH2_DBG_CTDREQ_CH2_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH3_DBG_CTDREQ_CH3_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH4_DBG_CTDREQ_CH4_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH5_DBG_CTDREQ_CH5_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH6_DBG_CTDREQ_CH6_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH7_DBG_CTDREQ_CH7_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH8_DBG_CTDREQ_CH8_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH9_DBG_CTDREQ_CH9_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH10_DBG_CTDREQ_CH10_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   subtype CH11_DBG_CTDREQ_CH11_DBG_CTDREQ_Field is RP2040.UInt6;
   ...
   type DMA_Peripheral is record
      ...
      CH0_READ_ADDR             : aliased RP2040.UInt32;
      ...
      CH0_WRITE_ADDR            : aliased RP2040.UInt32;
      ...
      CH0_TRANS_COUNT           : aliased RP2040.UInt32;
      --  DMA Channel 0 Control and Status
      CH0_CTRL_TRIG             : aliased CH0_CTRL_TRIG_Register;
      --  Alias for channel 0 CTRL register
      CH0_AL1_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 0 READ_ADDR register
      CH0_AL1_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 0 WRITE_ADDR register
      CH0_AL1_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 0 TRANS_COUNT register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH0_AL1_TRANS_COUNT_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 0 CTRL register
      CH0_AL2_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 0 TRANS_COUNT register
      CH0_AL2_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 0 READ_ADDR register
      CH0_AL2_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 0 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH0_AL2_WRITE_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Alias for channel 0 CTRL register
      CH0_AL3_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 0 WRITE_ADDR register
      CH0_AL3_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 0 TRANS_COUNT register
      CH0_AL3_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 0 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH0_AL3_READ_ADDR_TRIG    : aliased RP2040.UInt32;
      --  DMA Channel 1 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH1_READ_ADDR             : aliased RP2040.UInt32;
      --  DMA Channel 1 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH1_WRITE_ADDR            : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH1_TRANS_COUNT           : aliased RP2040.UInt32;
      --  DMA Channel 1 Control and Status
      CH1_CTRL_TRIG             : aliased CH1_CTRL_TRIG_Register;
      --  Alias for channel 1 CTRL register
      CH1_AL1_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 1 READ_ADDR register
      CH1_AL1_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 1 WRITE_ADDR register
      CH1_AL1_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 1 TRANS_COUNT register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH1_AL1_TRANS_COUNT_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 1 CTRL register
      CH1_AL2_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 1 TRANS_COUNT register
      CH1_AL2_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 1 READ_ADDR register
      CH1_AL2_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 1 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH1_AL2_WRITE_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Alias for channel 1 CTRL register
      CH1_AL3_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 1 WRITE_ADDR register
      CH1_AL3_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 1 TRANS_COUNT register
      CH1_AL3_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 1 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH1_AL3_READ_ADDR_TRIG    : aliased RP2040.UInt32;
      --  DMA Channel 2 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH2_READ_ADDR             : aliased RP2040.UInt32;
      --  DMA Channel 2 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH2_WRITE_ADDR            : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH2_TRANS_COUNT           : aliased RP2040.UInt32;
      --  DMA Channel 2 Control and Status
      CH2_CTRL_TRIG             : aliased CH2_CTRL_TRIG_Register;
      --  Alias for channel 2 CTRL register
      CH2_AL1_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 2 READ_ADDR register
      CH2_AL1_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 2 WRITE_ADDR register
      CH2_AL1_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 2 TRANS_COUNT register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH2_AL1_TRANS_COUNT_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 2 CTRL register
      CH2_AL2_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 2 TRANS_COUNT register
      CH2_AL2_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 2 READ_ADDR register
      CH2_AL2_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 2 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH2_AL2_WRITE_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Alias for channel 2 CTRL register
      CH2_AL3_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 2 WRITE_ADDR register
      CH2_AL3_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 2 TRANS_COUNT register
      CH2_AL3_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 2 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH2_AL3_READ_ADDR_TRIG    : aliased RP2040.UInt32;
      --  DMA Channel 3 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH3_READ_ADDR             : aliased RP2040.UInt32;
      --  DMA Channel 3 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH3_WRITE_ADDR            : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH3_TRANS_COUNT           : aliased RP2040.UInt32;
      --  DMA Channel 3 Control and Status
      CH3_CTRL_TRIG             : aliased CH3_CTRL_TRIG_Register;
      --  Alias for channel 3 CTRL register
      CH3_AL1_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 3 READ_ADDR register
      CH3_AL1_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 3 WRITE_ADDR register
      CH3_AL1_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 3 TRANS_COUNT register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH3_AL1_TRANS_COUNT_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 3 CTRL register
      CH3_AL2_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 3 TRANS_COUNT register
      CH3_AL2_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 3 READ_ADDR register
      CH3_AL2_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 3 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH3_AL2_WRITE_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Alias for channel 3 CTRL register
      CH3_AL3_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 3 WRITE_ADDR register
      CH3_AL3_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 3 TRANS_COUNT register
      CH3_AL3_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 3 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH3_AL3_READ_ADDR_TRIG    : aliased RP2040.UInt32;
      --  DMA Channel 4 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH4_READ_ADDR             : aliased RP2040.UInt32;
      --  DMA Channel 4 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH4_WRITE_ADDR            : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH4_TRANS_COUNT           : aliased RP2040.UInt32;
      --  DMA Channel 4 Control and Status
      CH4_CTRL_TRIG             : aliased CH4_CTRL_TRIG_Register;
      --  Alias for channel 4 CTRL register
      CH4_AL1_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 4 READ_ADDR register
      CH4_AL1_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 4 WRITE_ADDR register
      CH4_AL1_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 4 TRANS_COUNT register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH4_AL1_TRANS_COUNT_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 4 CTRL register
      CH4_AL2_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 4 TRANS_COUNT register
      CH4_AL2_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 4 READ_ADDR register
      CH4_AL2_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 4 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH4_AL2_WRITE_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Alias for channel 4 CTRL register
      CH4_AL3_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 4 WRITE_ADDR register
      CH4_AL3_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 4 TRANS_COUNT register
      CH4_AL3_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 4 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH4_AL3_READ_ADDR_TRIG    : aliased RP2040.UInt32;
      --  DMA Channel 5 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH5_READ_ADDR             : aliased RP2040.UInt32;
      --  DMA Channel 5 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH5_WRITE_ADDR            : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH5_TRANS_COUNT           : aliased RP2040.UInt32;
      --  DMA Channel 5 Control and Status
      CH5_CTRL_TRIG             : aliased CH5_CTRL_TRIG_Register;
      --  Alias for channel 5 CTRL register
      CH5_AL1_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 5 READ_ADDR register
      CH5_AL1_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 5 WRITE_ADDR register
      CH5_AL1_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 5 TRANS_COUNT register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH5_AL1_TRANS_COUNT_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 5 CTRL register
      CH5_AL2_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 5 TRANS_COUNT register
      CH5_AL2_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 5 READ_ADDR register
      CH5_AL2_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 5 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH5_AL2_WRITE_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Alias for channel 5 CTRL register
      CH5_AL3_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 5 WRITE_ADDR register
      CH5_AL3_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 5 TRANS_COUNT register
      CH5_AL3_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 5 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH5_AL3_READ_ADDR_TRIG    : aliased RP2040.UInt32;
      --  DMA Channel 6 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH6_READ_ADDR             : aliased RP2040.UInt32;
      --  DMA Channel 6 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH6_WRITE_ADDR            : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH6_TRANS_COUNT           : aliased RP2040.UInt32;
      --  DMA Channel 6 Control and Status
      CH6_CTRL_TRIG             : aliased CH6_CTRL_TRIG_Register;
      --  Alias for channel 6 CTRL register
      CH6_AL1_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 6 READ_ADDR register
      CH6_AL1_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 6 WRITE_ADDR register
      CH6_AL1_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 6 TRANS_COUNT register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH6_AL1_TRANS_COUNT_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 6 CTRL register
      CH6_AL2_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 6 TRANS_COUNT register
      CH6_AL2_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 6 READ_ADDR register
      CH6_AL2_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 6 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH6_AL2_WRITE_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Alias for channel 6 CTRL register
      CH6_AL3_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 6 WRITE_ADDR register
      CH6_AL3_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 6 TRANS_COUNT register
      CH6_AL3_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 6 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH6_AL3_READ_ADDR_TRIG    : aliased RP2040.UInt32;
      --  DMA Channel 7 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH7_READ_ADDR             : aliased RP2040.UInt32;
      --  DMA Channel 7 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH7_WRITE_ADDR            : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH7_TRANS_COUNT           : aliased RP2040.UInt32;
      --  DMA Channel 7 Control and Status
      CH7_CTRL_TRIG             : aliased CH7_CTRL_TRIG_Register;
      --  Alias for channel 7 CTRL register
      CH7_AL1_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 7 READ_ADDR register
      CH7_AL1_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 7 WRITE_ADDR register
      CH7_AL1_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 7 TRANS_COUNT register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH7_AL1_TRANS_COUNT_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 7 CTRL register
      CH7_AL2_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 7 TRANS_COUNT register
      CH7_AL2_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 7 READ_ADDR register
      CH7_AL2_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 7 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH7_AL2_WRITE_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Alias for channel 7 CTRL register
      CH7_AL3_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 7 WRITE_ADDR register
      CH7_AL3_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 7 TRANS_COUNT register
      CH7_AL3_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 7 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH7_AL3_READ_ADDR_TRIG    : aliased RP2040.UInt32;
      --  DMA Channel 8 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH8_READ_ADDR             : aliased RP2040.UInt32;
      --  DMA Channel 8 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH8_WRITE_ADDR            : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH8_TRANS_COUNT           : aliased RP2040.UInt32;
      --  DMA Channel 8 Control and Status
      CH8_CTRL_TRIG             : aliased CH8_CTRL_TRIG_Register;
      --  Alias for channel 8 CTRL register
      CH8_AL1_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 8 READ_ADDR register
      CH8_AL1_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 8 WRITE_ADDR register
      CH8_AL1_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 8 TRANS_COUNT register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH8_AL1_TRANS_COUNT_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 8 CTRL register
      CH8_AL2_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 8 TRANS_COUNT register
      CH8_AL2_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 8 READ_ADDR register
      CH8_AL2_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 8 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH8_AL2_WRITE_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Alias for channel 8 CTRL register
      CH8_AL3_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 8 WRITE_ADDR register
      CH8_AL3_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 8 TRANS_COUNT register
      CH8_AL3_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 8 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH8_AL3_READ_ADDR_TRIG    : aliased RP2040.UInt32;
      --  DMA Channel 9 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH9_READ_ADDR             : aliased RP2040.UInt32;
      --  DMA Channel 9 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH9_WRITE_ADDR            : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH9_TRANS_COUNT           : aliased RP2040.UInt32;
      --  DMA Channel 9 Control and Status
      CH9_CTRL_TRIG             : aliased CH9_CTRL_TRIG_Register;
      --  Alias for channel 9 CTRL register
      CH9_AL1_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 9 READ_ADDR register
      CH9_AL1_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 9 WRITE_ADDR register
      CH9_AL1_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 9 TRANS_COUNT register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH9_AL1_TRANS_COUNT_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 9 CTRL register
      CH9_AL2_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 9 TRANS_COUNT register
      CH9_AL2_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 9 READ_ADDR register
      CH9_AL2_READ_ADDR         : aliased RP2040.UInt32;
      --  Alias for channel 9 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH9_AL2_WRITE_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Alias for channel 9 CTRL register
      CH9_AL3_CTRL              : aliased RP2040.UInt32;
      --  Alias for channel 9 WRITE_ADDR register
      CH9_AL3_WRITE_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 9 TRANS_COUNT register
      CH9_AL3_TRANS_COUNT       : aliased RP2040.UInt32;
      --  Alias for channel 9 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH9_AL3_READ_ADDR_TRIG    : aliased RP2040.UInt32;
      --  DMA Channel 10 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH10_READ_ADDR            : aliased RP2040.UInt32;
      --  DMA Channel 10 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH10_WRITE_ADDR           : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH10_TRANS_COUNT          : aliased RP2040.UInt32;
      --  DMA Channel 10 Control and Status
      CH10_CTRL_TRIG            : aliased CH10_CTRL_TRIG_Register;
      --  Alias for channel 10 CTRL register
      CH10_AL1_CTRL             : aliased RP2040.UInt32;
      --  Alias for channel 10 READ_ADDR register
      CH10_AL1_READ_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 10 WRITE_ADDR register
      CH10_AL1_WRITE_ADDR       : aliased RP2040.UInt32;
      --  Alias for channel 10 TRANS_COUNT register\n This is a trigger
      --  register (0xc). Writing a nonzero value will\n reload the channel
      --  counter and start the channel.
      CH10_AL1_TRANS_COUNT_TRIG : aliased RP2040.UInt32;
      --  Alias for channel 10 CTRL register
      CH10_AL2_CTRL             : aliased RP2040.UInt32;
      --  Alias for channel 10 TRANS_COUNT register
      CH10_AL2_TRANS_COUNT      : aliased RP2040.UInt32;
      --  Alias for channel 10 READ_ADDR register
      CH10_AL2_READ_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 10 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH10_AL2_WRITE_ADDR_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 10 CTRL register
      CH10_AL3_CTRL             : aliased RP2040.UInt32;
      --  Alias for channel 10 WRITE_ADDR register
      CH10_AL3_WRITE_ADDR       : aliased RP2040.UInt32;
      --  Alias for channel 10 TRANS_COUNT register
      CH10_AL3_TRANS_COUNT      : aliased RP2040.UInt32;
      --  Alias for channel 10 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH10_AL3_READ_ADDR_TRIG   : aliased RP2040.UInt32;
      --  DMA Channel 11 Read Address pointer\n This register updates
      --  automatically each time a read completes. The current value is the
      --  next address to be read by this channel.
      CH11_READ_ADDR            : aliased RP2040.UInt32;
      --  DMA Channel 11 Write Address pointer\n This register updates
      --  automatically each time a write completes. The current value is the
      --  next address to be written by this channel.
      CH11_WRITE_ADDR           : aliased RP2040.UInt32;
      ...
      --  the written value is used immediately as the length of the new
      --  transfer sequence, as well as being written to RELOAD.
      CH11_TRANS_COUNT          : aliased RP2040.UInt32;
      --  DMA Channel 11 Control and Status
      CH11_CTRL_TRIG            : aliased CH11_CTRL_TRIG_Register;
      --  Alias for channel 11 CTRL register
      CH11_AL1_CTRL             : aliased RP2040.UInt32;
      --  Alias for channel 11 READ_ADDR register
      CH11_AL1_READ_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 11 WRITE_ADDR register
      CH11_AL1_WRITE_ADDR       : aliased RP2040.UInt32;
      --  Alias for channel 11 TRANS_COUNT register\n This is a trigger
      --  register (0xc). Writing a nonzero value will\n reload the channel
      --  counter and start the channel.
      CH11_AL1_TRANS_COUNT_TRIG : aliased RP2040.UInt32;
      --  Alias for channel 11 CTRL register
      CH11_AL2_CTRL             : aliased RP2040.UInt32;
      --  Alias for channel 11 TRANS_COUNT register
      CH11_AL2_TRANS_COUNT      : aliased RP2040.UInt32;
      --  Alias for channel 11 READ_ADDR register
      CH11_AL2_READ_ADDR        : aliased RP2040.UInt32;
      --  Alias for channel 11 WRITE_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH11_AL2_WRITE_ADDR_TRIG  : aliased RP2040.UInt32;
      --  Alias for channel 11 CTRL register
      CH11_AL3_CTRL             : aliased RP2040.UInt32;
      --  Alias for channel 11 WRITE_ADDR register
      CH11_AL3_WRITE_ADDR       : aliased RP2040.UInt32;
      --  Alias for channel 11 TRANS_COUNT register
      CH11_AL3_TRANS_COUNT      : aliased RP2040.UInt32;
      --  Alias for channel 11 READ_ADDR register\n This is a trigger register
      --  (0xc). Writing a nonzero value will\n reload the channel counter and
      --  start the channel.
      CH11_AL3_READ_ADDR_TRIG   : aliased RP2040.UInt32;
      --  Interrupt Status (raw)
      ...
      SNIFF_DATA                : aliased RP2040.UInt32;
      --  Debug RAF, WAF, TDF levels
      ...
      --  next transfer
      CH0_DBG_TCR               : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH1_DBG_TCR               : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH2_DBG_TCR               : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH3_DBG_TCR               : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH4_DBG_TCR               : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH5_DBG_TCR               : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH6_DBG_TCR               : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH7_DBG_TCR               : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH8_DBG_TCR               : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH9_DBG_TCR               : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH10_DBG_TCR              : aliased RP2040.UInt32;
      --  Read: get channel DREQ counter (i.e. how many accesses the DMA
      --  expects it can perform on the peripheral without overflow/underflow.
      --  Write any value: clears the counter, and cause channel to re-initiate
      --  DREQ handshake.
      ...
      --  Read to get channel TRANS_COUNT reload value, i.e. the length of the
      --  next transfer
      CH11_DBG_TCR              : aliased RP2040.UInt32;
   end record
     with Volatile;
