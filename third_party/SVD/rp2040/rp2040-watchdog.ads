...
package RP2040.WATCHDOG with No_Elaboration_Code_All is
   pragma Preelaborate;
   ...
   subtype CTRL_TIME_Field is RP2040.UInt24;
   subtype CTRL_PAUSE_JTAG_Field is RP2040.Bit;
   --  CTRL_PAUSE_DBG array element
   subtype CTRL_PAUSE_DBG_Element is RP2040.Bit;
   ...
   subtype CTRL_ENABLE_Field is RP2040.Bit;
   subtype CTRL_TRIGGER_Field is RP2040.Bit;
   ...
   type CTRL_Register is record
      ...
      --  unspecified
      Reserved_27_29 : RP2040.UInt3 := 16#0#;
   ...
   subtype LOAD_LOAD_Field is RP2040.UInt24;
   ...
   subtype REASON_TIMER_Field is RP2040.Bit;
   subtype REASON_FORCE_Field is RP2040.Bit;
   ...
   subtype TICK_CYCLES_Field is RP2040.UInt9;
   subtype TICK_ENABLE_Field is RP2040.Bit;
   subtype TICK_RUNNING_Field is RP2040.Bit;
   subtype TICK_COUNT_Field is RP2040.UInt9;
   ...
   type WATCHDOG_Peripheral is record
      ...
      --  chip.
      SCRATCH0 : aliased RP2040.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH1 : aliased RP2040.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH2 : aliased RP2040.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH3 : aliased RP2040.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH4 : aliased RP2040.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH5 : aliased RP2040.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH6 : aliased RP2040.UInt32;
      --  Scratch register. Information persists through soft reset of the
      --  chip.
      SCRATCH7 : aliased RP2040.UInt32;
      --  Controls the tick generator
