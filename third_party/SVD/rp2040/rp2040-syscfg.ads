...
package RP2040.SYSCFG is
   ...
   subtype PROC_CONFIG_PROC0_HALTED_Field is RP2040.Bit;
   subtype PROC_CONFIG_PROC1_HALTED_Field is RP2040.Bit;
   subtype PROC_CONFIG_PROC0_DAP_INSTID_Field is RP2040.UInt4;
   subtype PROC_CONFIG_PROC1_DAP_INSTID_Field is RP2040.UInt4;
   ...
   type PROC_CONFIG_Register is record
      ...
      --  unspecified
      Reserved_2_23    : RP2040.UInt22 := 16#0#;
   ...
   subtype PROC_IN_SYNC_BYPASS_PROC_IN_SYNC_BYPASS_Field is RP2040.UInt30;
   ...
   subtype PROC_IN_SYNC_BYPASS_HI_PROC_IN_SYNC_BYPASS_HI_Field is RP2040.UInt6;
   ...
   subtype DBGFORCE_PROC0_SWDO_Field is RP2040.Bit;
   subtype DBGFORCE_PROC0_SWDI_Field is RP2040.Bit;
   subtype DBGFORCE_PROC0_SWCLK_Field is RP2040.Bit;
   subtype DBGFORCE_PROC0_ATTACH_Field is RP2040.Bit;
   subtype DBGFORCE_PROC1_SWDO_Field is RP2040.Bit;
   subtype DBGFORCE_PROC1_SWDI_Field is RP2040.Bit;
   subtype DBGFORCE_PROC1_SWCLK_Field is RP2040.Bit;
   subtype DBGFORCE_PROC1_ATTACH_Field is RP2040.Bit;
   ...
   subtype MEMPOWERDOWN_SRAM_Element is RP2040.Bit;
   ...
   subtype MEMPOWERDOWN_USB_Field is RP2040.Bit;
   subtype MEMPOWERDOWN_ROM_Field is RP2040.Bit;
   ...
   type SYSCFG_Peripheral is record
      ...
      --  that IRQ
      PROC0_NMI_MASK         : aliased RP2040.UInt32;
      --  Processor core 1 NMI source mask\n Set a bit high to enable NMI from
      --  that IRQ
      PROC1_NMI_MASK         : aliased RP2040.UInt32;
      --  Configuration for processors
