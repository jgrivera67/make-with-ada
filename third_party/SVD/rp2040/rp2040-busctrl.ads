...
package RP2040.BUSCTRL is
   ...
   subtype BUS_PRIORITY_PROC0_Field is RP2040.Bit;
   subtype BUS_PRIORITY_PROC1_Field is RP2040.Bit;
   subtype BUS_PRIORITY_DMA_R_Field is RP2040.Bit;
   subtype BUS_PRIORITY_DMA_W_Field is RP2040.Bit;

   --  Set the priority of each master for bus arbitration.
   type BUS_PRIORITY_Register is record
      --  0 - low priority, 1 - high priority
      PROC0          : BUS_PRIORITY_PROC0_Field := 16#0#;
      --  unspecified
      Reserved_1_3   : RP2040.UInt3 := 16#0#;
      --  0 - low priority, 1 - high priority
      PROC1          : BUS_PRIORITY_PROC1_Field := 16#0#;
      --  unspecified
      Reserved_5_7   : RP2040.UInt3 := 16#0#;
      --  0 - low priority, 1 - high priority
      DMA_R          : BUS_PRIORITY_DMA_R_Field := 16#0#;
      --  unspecified
      Reserved_9_11  : RP2040.UInt3 := 16#0#;
      --  0 - low priority, 1 - high priority
      DMA_W          : BUS_PRIORITY_DMA_W_Field := 16#0#;
      --  unspecified
   ...
   subtype BUS_PRIORITY_ACK_BUS_PRIORITY_ACK_Field is RP2040.Bit;
   ...
   type BUS_PRIORITY_ACK_Register is record
      ...
      BUS_PRIORITY_ACK : BUS_PRIORITY_ACK_BUS_PRIORITY_ACK_Field;
      --  unspecified
   ...
   subtype PERFCTR0_PERFCTR0_Field is RP2040.UInt24;
   ...
   subtype PERFSEL0_PERFSEL0_Field is RP2040.UInt5;
   ...
   subtype PERFCTR1_PERFCTR1_Field is RP2040.UInt24;
   ...
   subtype PERFSEL1_PERFSEL1_Field is RP2040.UInt5;
   ...
   subtype PERFCTR2_PERFCTR2_Field is RP2040.UInt24;
   ...
   subtype PERFSEL2_PERFSEL2_Field is RP2040.UInt5;
   ...
   subtype PERFCTR3_PERFCTR3_Field is RP2040.UInt24;
   ...
   subtype PERFSEL3_PERFSEL3_Field is RP2040.UInt5;
