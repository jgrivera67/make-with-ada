...
package RP2040.PLL_USB with No_Elaboration_Code_All is
   pragma Preelaborate;
   ...
   subtype CS_REFDIV_Field is RP2040.UInt6;
   subtype CS_BYPASS_Field is RP2040.Bit;
   subtype CS_LOCK_Field is RP2040.Bit;
   ...
   type CS_Register is record
      ...
      --  unspecified
      Reserved_9_30 : RP2040.UInt22 := 16#0#;
   ...
   subtype PWR_PD_Field is RP2040.Bit;
   subtype PWR_DSMPD_Field is RP2040.Bit;
   subtype PWR_POSTDIVPD_Field is RP2040.Bit;
   subtype PWR_VCOPD_Field is RP2040.Bit;
   ...
   subtype FBDIV_INT_FBDIV_INT_Field is RP2040.UInt12;
   ...
   subtype PRIM_POSTDIV2_Field is RP2040.UInt3;
   subtype PRIM_POSTDIV1_Field is RP2040.UInt3;
   ...
   type PRIM_Register is record
      ...
      --  unspecified
      Reserved_19_31 : RP2040.UInt13 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
