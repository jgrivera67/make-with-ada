...
package RP2040.ADC is
   ...
   subtype CS_EN_Field is RP2040.Bit;
   subtype CS_TS_EN_Field is RP2040.Bit;
   subtype CS_START_ONCE_Field is RP2040.Bit;
   subtype CS_START_MANY_Field is RP2040.Bit;
   subtype CS_READY_Field is RP2040.Bit;
   subtype CS_ERR_Field is RP2040.Bit;
   subtype CS_ERR_STICKY_Field is RP2040.Bit;
   subtype CS_AINSEL_Field is RP2040.UInt3;
   subtype CS_RROBIN_Field is RP2040.UInt5;
   ...
   subtype RESULT_RESULT_Field is RP2040.UInt12;
   ...
   subtype FCS_EN_Field is RP2040.Bit;
   subtype FCS_SHIFT_Field is RP2040.Bit;
   subtype FCS_ERR_Field is RP2040.Bit;
   subtype FCS_DREQ_EN_Field is RP2040.Bit;
   subtype FCS_EMPTY_Field is RP2040.Bit;
   subtype FCS_FULL_Field is RP2040.Bit;
   subtype FCS_UNDER_Field is RP2040.Bit;
   subtype FCS_OVER_Field is RP2040.Bit;
   subtype FCS_LEVEL_Field is RP2040.UInt4;
   subtype FCS_THRESH_Field is RP2040.UInt4;
   ...
   subtype FIFO_VAL_Field is RP2040.UInt12;
   subtype FIFO_ERR_Field is RP2040.Bit;
   ...
   subtype DIV_FRAC_Field is RP2040.Byte;
   subtype DIV_INT_Field is RP2040.UInt16;
   ...
   subtype INTR_FIFO_Field is RP2040.Bit;
   ...
   subtype INTE_FIFO_Field is RP2040.Bit;
   ...
   subtype INTF_FIFO_Field is RP2040.Bit;
   ...
   subtype INTS_FIFO_Field is RP2040.Bit;
