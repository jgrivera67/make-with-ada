...
package RP2040.XIP_SSI is
   ...
   subtype CTRLR0_DFS_Field is RP2040.UInt4;
   subtype CTRLR0_FRF_Field is RP2040.UInt2;
   subtype CTRLR0_SCPH_Field is RP2040.Bit;
   subtype CTRLR0_SCPOL_Field is RP2040.Bit;
   ...
   subtype CTRLR0_SLV_OE_Field is RP2040.Bit;
   subtype CTRLR0_SRL_Field is RP2040.Bit;
   subtype CTRLR0_CFS_Field is RP2040.UInt4;
   subtype CTRLR0_DFS_32_Field is RP2040.UInt5;
   ...
   subtype CTRLR0_SSTE_Field is RP2040.Bit;
   ...
   type CTRLR0_Register is record
      ...
      --  Transfer mode
      TMOD           : CTRLR0_TMOD_Field := RP2040.XIP_SSI.TX_AND_RX;
      --  Slave output enable
      ...
      --  SPI frame format
      SPI_FRF        : CTRLR0_SPI_FRF_Field := RP2040.XIP_SSI.STD;
      --  unspecified
      Reserved_23_23 : RP2040.Bit := 16#0#;
   ...
   subtype CTRLR1_NDF_Field is RP2040.UInt16;
   ...
   subtype SSIENR_SSI_EN_Field is RP2040.Bit;
   ...
   subtype MWCR_MWMOD_Field is RP2040.Bit;
   subtype MWCR_MDD_Field is RP2040.Bit;
   subtype MWCR_MHS_Field is RP2040.Bit;
   ...
   subtype SER_SER_Field is RP2040.Bit;
   ...
   subtype BAUDR_SCKDV_Field is RP2040.UInt16;
   ...
   subtype TXFTLR_TFT_Field is RP2040.Byte;
   ...
   subtype RXFTLR_RFT_Field is RP2040.Byte;
   ...
   subtype TXFLR_TFTFL_Field is RP2040.Byte;
   ...
   subtype RXFLR_RXTFL_Field is RP2040.Byte;
   ...
   subtype SR_BUSY_Field is RP2040.Bit;
   subtype SR_TFNF_Field is RP2040.Bit;
   subtype SR_TFE_Field is RP2040.Bit;
   subtype SR_RFNE_Field is RP2040.Bit;
   subtype SR_RFF_Field is RP2040.Bit;
   subtype SR_TXE_Field is RP2040.Bit;
   subtype SR_DCOL_Field is RP2040.Bit;
   ...
   subtype IMR_TXEIM_Field is RP2040.Bit;
   subtype IMR_TXOIM_Field is RP2040.Bit;
   subtype IMR_RXUIM_Field is RP2040.Bit;
   subtype IMR_RXOIM_Field is RP2040.Bit;
   subtype IMR_RXFIM_Field is RP2040.Bit;
   subtype IMR_MSTIM_Field is RP2040.Bit;
   ...
   subtype ISR_TXEIS_Field is RP2040.Bit;
   subtype ISR_TXOIS_Field is RP2040.Bit;
   subtype ISR_RXUIS_Field is RP2040.Bit;
   subtype ISR_RXOIS_Field is RP2040.Bit;
   subtype ISR_RXFIS_Field is RP2040.Bit;
   subtype ISR_MSTIS_Field is RP2040.Bit;
   ...
   subtype RISR_TXEIR_Field is RP2040.Bit;
   subtype RISR_TXOIR_Field is RP2040.Bit;
   subtype RISR_RXUIR_Field is RP2040.Bit;
   subtype RISR_RXOIR_Field is RP2040.Bit;
   subtype RISR_RXFIR_Field is RP2040.Bit;
   subtype RISR_MSTIR_Field is RP2040.Bit;
   ...
   subtype TXOICR_TXOICR_Field is RP2040.Bit;
   ...
   subtype RXOICR_RXOICR_Field is RP2040.Bit;
   ...
   subtype RXUICR_RXUICR_Field is RP2040.Bit;
   ...
   subtype MSTICR_MSTICR_Field is RP2040.Bit;
   ...
   subtype ICR_ICR_Field is RP2040.Bit;
   ...
   subtype DMACR_RDMAE_Field is RP2040.Bit;
   subtype DMACR_TDMAE_Field is RP2040.Bit;
   ...
   subtype DMATDLR_DMATDL_Field is RP2040.Byte;
   ...
   subtype DMARDLR_DMARDL_Field is RP2040.Byte;
   ...
   subtype RX_SAMPLE_DLY_RSD_Field is RP2040.Byte;
   ...
   subtype SPI_CTRLR0_ADDR_L_Field is RP2040.UInt4;
   ...
   subtype SPI_CTRLR0_WAIT_CYCLES_Field is RP2040.UInt5;
   subtype SPI_CTRLR0_SPI_DDR_EN_Field is RP2040.Bit;
   subtype SPI_CTRLR0_INST_DDR_EN_Field is RP2040.Bit;
   subtype SPI_CTRLR0_SPI_RXDS_EN_Field is RP2040.Bit;
   subtype SPI_CTRLR0_XIP_CMD_Field is RP2040.Byte;

   --  SPI control
   type SPI_CTRLR0_Register is record
      --  Address and instruction transfer format
      TRANS_TYPE     : SPI_CTRLR0_TRANS_TYPE_Field := RP2040.XIP_SSI.Val_1C1A;
      --  Address length (0b-60b in 4b increments)
      ADDR_L         : SPI_CTRLR0_ADDR_L_Field := 16#0#;
      --  unspecified
      Reserved_6_7   : RP2040.UInt2 := 16#0#;
      --  Instruction length (0/4/8/16b)
      INST_L         : SPI_CTRLR0_INST_L_Field := RP2040.XIP_SSI.NONE;
      --  unspecified
      Reserved_10_10 : RP2040.Bit := 16#0#;
   ...
   subtype TXD_DRIVE_EDGE_TDE_Field is RP2040.Byte;
   ...
   type XIP_SSI_Peripheral is record
      ...
      IDR            : aliased RP2040.UInt32;
      --  Version ID
      SSI_VERSION_ID : aliased RP2040.UInt32;
      --  Data Register 0 (of 36)
      DR0            : aliased RP2040.UInt32;
      --  RX sample delay
