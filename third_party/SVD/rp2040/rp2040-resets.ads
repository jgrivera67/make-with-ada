...
package RP2040.RESETS is
   ...
   subtype RESET_adc_Field is RP2040.Bit;
   subtype RESET_busctrl_Field is RP2040.Bit;
   subtype RESET_dma_Field is RP2040.Bit;
   --  RESET_i2c array element
   subtype RESET_i2c_Element is RP2040.Bit;
   ...
   subtype RESET_io_bank0_Field is RP2040.Bit;
   subtype RESET_io_qspi_Field is RP2040.Bit;
   subtype RESET_jtag_Field is RP2040.Bit;
   subtype RESET_pads_bank0_Field is RP2040.Bit;
   subtype RESET_pads_qspi_Field is RP2040.Bit;
   --  RESET_pio array element
   subtype RESET_pio_Element is RP2040.Bit;
   ...
   subtype RESET_pll_sys_Field is RP2040.Bit;
   subtype RESET_pll_usb_Field is RP2040.Bit;
   subtype RESET_pwm_Field is RP2040.Bit;
   subtype RESET_rtc_Field is RP2040.Bit;
   --  RESET_spi array element
   subtype RESET_spi_Element is RP2040.Bit;
   ...
   subtype RESET_syscfg_Field is RP2040.Bit;
   subtype RESET_sysinfo_Field is RP2040.Bit;
   subtype RESET_tbman_Field is RP2040.Bit;
   subtype RESET_timer_Field is RP2040.Bit;
   --  RESET_uart array element
   subtype RESET_uart_Element is RP2040.Bit;
   ...
   subtype RESET_usbctrl_Field is RP2040.Bit;
   ...
   subtype WDSEL_adc_Field is RP2040.Bit;
   subtype WDSEL_busctrl_Field is RP2040.Bit;
   subtype WDSEL_dma_Field is RP2040.Bit;
   --  WDSEL_i2c array element
   subtype WDSEL_i2c_Element is RP2040.Bit;
   ...
   subtype WDSEL_io_bank0_Field is RP2040.Bit;
   subtype WDSEL_io_qspi_Field is RP2040.Bit;
   subtype WDSEL_jtag_Field is RP2040.Bit;
   subtype WDSEL_pads_bank0_Field is RP2040.Bit;
   subtype WDSEL_pads_qspi_Field is RP2040.Bit;
   --  WDSEL_pio array element
   subtype WDSEL_pio_Element is RP2040.Bit;
   ...
   subtype WDSEL_pll_sys_Field is RP2040.Bit;
   subtype WDSEL_pll_usb_Field is RP2040.Bit;
   subtype WDSEL_pwm_Field is RP2040.Bit;
   subtype WDSEL_rtc_Field is RP2040.Bit;
   --  WDSEL_spi array element
   subtype WDSEL_spi_Element is RP2040.Bit;
   ...
   subtype WDSEL_syscfg_Field is RP2040.Bit;
   subtype WDSEL_sysinfo_Field is RP2040.Bit;
   subtype WDSEL_tbman_Field is RP2040.Bit;
   subtype WDSEL_timer_Field is RP2040.Bit;
   --  WDSEL_uart array element
   subtype WDSEL_uart_Element is RP2040.Bit;
   ...
   subtype WDSEL_usbctrl_Field is RP2040.Bit;
   ...
   subtype RESET_DONE_adc_Field is RP2040.Bit;
   subtype RESET_DONE_busctrl_Field is RP2040.Bit;
   subtype RESET_DONE_dma_Field is RP2040.Bit;
   --  RESET_DONE_i2c array element
   subtype RESET_DONE_i2c_Element is RP2040.Bit;
   ...
   subtype RESET_DONE_io_bank0_Field is RP2040.Bit;
   subtype RESET_DONE_io_qspi_Field is RP2040.Bit;
   subtype RESET_DONE_jtag_Field is RP2040.Bit;
   subtype RESET_DONE_pads_bank0_Field is RP2040.Bit;
   subtype RESET_DONE_pads_qspi_Field is RP2040.Bit;
   --  RESET_DONE_pio array element
   subtype RESET_DONE_pio_Element is RP2040.Bit;
   ...
   subtype RESET_DONE_pll_sys_Field is RP2040.Bit;
   subtype RESET_DONE_pll_usb_Field is RP2040.Bit;
   subtype RESET_DONE_pwm_Field is RP2040.Bit;
   subtype RESET_DONE_rtc_Field is RP2040.Bit;
   --  RESET_DONE_spi array element
   subtype RESET_DONE_spi_Element is RP2040.Bit;
   ...
   subtype RESET_DONE_syscfg_Field is RP2040.Bit;
   subtype RESET_DONE_sysinfo_Field is RP2040.Bit;
   subtype RESET_DONE_tbman_Field is RP2040.Bit;
   subtype RESET_DONE_timer_Field is RP2040.Bit;
   --  RESET_DONE_uart array element
   subtype RESET_DONE_uart_Element is RP2040.Bit;
   ...
   subtype RESET_DONE_usbctrl_Field is RP2040.Bit;
