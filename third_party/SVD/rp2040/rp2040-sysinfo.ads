...
package RP2040.SYSINFO is
   ...
   subtype CHIP_ID_MANUFACTURER_Field is RP2040.UInt12;
   subtype CHIP_ID_PART_Field is RP2040.UInt16;
   subtype CHIP_ID_REVISION_Field is RP2040.UInt4;
   ...
   subtype PLATFORM_FPGA_Field is RP2040.Bit;
   subtype PLATFORM_ASIC_Field is RP2040.Bit;
   ...
   type SYSINFO_Peripheral is record
      ...
      GITREF_RP2040 : aliased RP2040.UInt32;
   end record
     with Volatile;
