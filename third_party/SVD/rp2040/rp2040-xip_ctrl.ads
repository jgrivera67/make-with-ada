...
package RP2040.XIP_CTRL is
   ...
   subtype CTRL_EN_Field is RP2040.Bit;
   subtype CTRL_ERR_BADWRITE_Field is RP2040.Bit;
   subtype CTRL_POWER_DOWN_Field is RP2040.Bit;
   ...
   type CTRL_Register is record
      ...
      --  tag match,\n as usual.
      ERR_BADWRITE  : CTRL_ERR_BADWRITE_Field := 16#1#;
      --  unspecified
      Reserved_2_2  : RP2040.Bit := 16#0#;
      ...
      POWER_DOWN    : CTRL_POWER_DOWN_Field := 16#0#;
      --  unspecified
   ...
   subtype FLUSH_FLUSH_Field is RP2040.Bit;
   ...
   subtype STAT_FLUSH_READY_Field is RP2040.Bit;
   subtype STAT_FIFO_EMPTY_Field is RP2040.Bit;
   subtype STAT_FIFO_FULL_Field is RP2040.Bit;
   ...
   type STAT_Register is record
      ...
      FLUSH_READY   : STAT_FLUSH_READY_Field;
      --  Read-only. When 1, indicates the XIP streaming FIFO is completely
      --  empty.
      FIFO_EMPTY    : STAT_FIFO_EMPTY_Field;
      --  Read-only. When 1, indicates the XIP streaming FIFO is completely
      --  full.\n The streaming FIFO is 2 entries deep, so the full and empty\n
      --  flag allow its level to be ascertained.
      FIFO_FULL     : STAT_FIFO_FULL_Field;
      --  unspecified
   ...
   subtype STREAM_ADDR_STREAM_ADDR_Field is RP2040.UInt30;

   --  FIFO stream address
   type STREAM_ADDR_Register is record
      --  unspecified
      Reserved_0_1 : RP2040.UInt2 := 16#0#;
   ...
   subtype STREAM_CTR_STREAM_CTR_Field is RP2040.UInt22;
   ...
   type STREAM_CTR_Register is record
      ...
      --  unspecified
      Reserved_22_31 : RP2040.UInt10 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type XIP_CTRL_Peripheral is record
      ...
      --  traffic.
      STREAM_FIFO : aliased RP2040.UInt32;
   end record
     with Volatile;
