...
package RP2040.PIO1 is
   ...
   type SM0_EXECCTRL_Register is record
      ...
      --  Comparison used for the MOV x, STATUS instruction.
      STATUS_SEL    : SM0_EXECCTRL_STATUS_SEL_Field := RP2040.PIO1.TXLEVEL;
      --  unspecified
   ...
   type SM1_EXECCTRL_Register is record
      ...
      --  Comparison used for the MOV x, STATUS instruction.
      STATUS_SEL    : SM1_EXECCTRL_STATUS_SEL_Field := RP2040.PIO1.TXLEVEL;
      --  unspecified
      Reserved_5_6  : RP2040.UInt2 := 16#0#;
      --  After reaching wrap_top, execution is wrapped to this address.
   ...
   type SM2_EXECCTRL_Register is record
      ...
      --  Comparison used for the MOV x, STATUS instruction.
      STATUS_SEL    : SM2_EXECCTRL_STATUS_SEL_Field := RP2040.PIO1.TXLEVEL;
      --  unspecified
      Reserved_5_6  : RP2040.UInt2 := 16#0#;
      --  After reaching wrap_top, execution is wrapped to this address.
   ...
   type SM3_EXECCTRL_Register is record
      ...
      --  Comparison used for the MOV x, STATUS instruction.
      STATUS_SEL    : SM3_EXECCTRL_STATUS_SEL_Field := RP2040.PIO1.TXLEVEL;
      --  unspecified
      Reserved_5_6  : RP2040.UInt2 := 16#0#;
      --  After reaching wrap_top, execution is wrapped to this address.
