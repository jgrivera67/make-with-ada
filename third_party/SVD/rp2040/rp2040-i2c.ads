...
package RP2040.I2C is
   ...
   subtype IC_CON_STOP_DET_IF_MASTER_ACTIVE_Field is RP2040.Bit;
   ...
   type IC_CON_Register is record
      ...
      SPEED                     : IC_CON_SPEED_Field := RP2040.I2C.FAST;
      --  When acting as a slave, this bit controls whether the DW_apb_i2c
      --  responds to 7- or 10-bit addresses. - 0: 7-bit addressing. The
      --  DW_apb_i2c ignores transactions that involve 10-bit addressing; for
      --  7-bit addressing, only the lower 7 bits of the IC_SAR register are
      ...
      STOP_DET_IF_MASTER_ACTIVE : IC_CON_STOP_DET_IF_MASTER_ACTIVE_Field :=
                                   16#0#;
      --  unspecified
   ...
   subtype IC_TAR_IC_TAR_Field is RP2040.UInt10;
   ...
   type IC_TAR_Register is record
      ...
      GC_OR_START    : IC_TAR_GC_OR_START_Field := RP2040.I2C.GENERAL_CALL;
      ...
      SPECIAL        : IC_TAR_SPECIAL_Field := RP2040.I2C.DISABLED;
      --  unspecified
   ...
   subtype IC_SAR_IC_SAR_Field is RP2040.UInt10;
   ...
   subtype IC_DATA_CMD_DAT_Field is RP2040.Byte;
   ...
   type IC_DATA_CMD_Register is record
      ...
      --  occurs.\n\n Reset value: 0x0
      CMD             : IC_DATA_CMD_CMD_Field := RP2040.I2C.WRITE;
      --  After a write operation all bits in the field are cleared (set to
      ...
      STOP            : IC_DATA_CMD_STOP_Field := RP2040.I2C.DISABLE;
      --  After a write operation all bits in the field are cleared (set to
      ...
      --  is issued instead.\n\n Reset value: 0x0
      RESTART         : IC_DATA_CMD_RESTART_Field := RP2040.I2C.DISABLE;
   ...
   subtype IC_SS_SCL_HCNT_IC_SS_SCL_HCNT_Field is RP2040.UInt16;
   ...
   subtype IC_SS_SCL_LCNT_IC_SS_SCL_LCNT_Field is RP2040.UInt16;
   ...
   subtype IC_FS_SCL_HCNT_IC_FS_SCL_HCNT_Field is RP2040.UInt16;
   ...
   subtype IC_FS_SCL_LCNT_IC_FS_SCL_LCNT_Field is RP2040.UInt16;
   ...
   type IC_INTR_MASK_Register is record
      ...
      M_MASTER_ON_HOLD_READ_ONLY : IC_INTR_MASK_M_MASTER_ON_HOLD_READ_ONLY_Field :=
                                    RP2040.I2C.ENABLED;
      --  unspecified
      Reserved_14_31             : RP2040.UInt18 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype IC_RX_TL_RX_TL_Field is RP2040.Byte;
   ...
   subtype IC_TX_TL_TX_TL_Field is RP2040.Byte;
   ...
   subtype IC_CLR_INTR_CLR_INTR_Field is RP2040.Bit;
   ...
   type IC_CLR_INTR_Register is record
      ...
      CLR_INTR      : IC_CLR_INTR_CLR_INTR_Field;
      --  unspecified
   ...
   subtype IC_CLR_TX_ABRT_CLR_TX_ABRT_Field is RP2040.Bit;
   ...
   type IC_CLR_TX_ABRT_Register is record
      ...
      --  value: 0x0
      CLR_TX_ABRT   : IC_CLR_TX_ABRT_CLR_TX_ABRT_Field;
      --  unspecified
      Reserved_1_31 : RP2040.UInt31;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype IC_CLR_ACTIVITY_CLR_ACTIVITY_Field is RP2040.Bit;
   ...
   type IC_CLR_ACTIVITY_Register is record
      ...
      CLR_ACTIVITY  : IC_CLR_ACTIVITY_CLR_ACTIVITY_Field;
      --  unspecified
      Reserved_1_31 : RP2040.UInt31;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype IC_CLR_START_DET_CLR_START_DET_Field is RP2040.Bit;
   ...
   type IC_CLR_START_DET_Register is record
      ...
      CLR_START_DET : IC_CLR_START_DET_CLR_START_DET_Field;
      --  unspecified
      Reserved_1_31 : RP2040.UInt31;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype IC_CLR_GEN_CALL_CLR_GEN_CALL_Field is RP2040.Bit;
   ...
   type IC_CLR_GEN_CALL_Register is record
      ...
      CLR_GEN_CALL  : IC_CLR_GEN_CALL_CLR_GEN_CALL_Field;
      --  unspecified
      Reserved_1_31 : RP2040.UInt31;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type IC_ENABLE_Register is record
      ...
      ENABLE        : IC_ENABLE_ENABLE_Field := RP2040.I2C.DISABLED;
      --  When set, the controller initiates the transfer abort. - 0: ABORT not
      --  initiated or ABORT done - 1: ABORT operation in progress The software
      --  can abort the I2C transfer in master mode by setting this bit. The
      --  software can set this bit only when ENABLE is already set; otherwise,
      ...
      ABORT_k       : IC_ENABLE_ABORT_Field := RP2040.I2C.DISABLE;
      ...
      TX_CMD_BLOCK  : IC_ENABLE_TX_CMD_BLOCK_Field := RP2040.I2C.NOT_BLOCKED;
      --  unspecified
   ...
   subtype IC_TXFLR_TXFLR_Field is RP2040.UInt5;
   ...
   subtype IC_RXFLR_RXFLR_Field is RP2040.UInt5;
   ...
   subtype IC_SDA_HOLD_IC_SDA_TX_HOLD_Field is RP2040.UInt16;
   subtype IC_SDA_HOLD_IC_SDA_RX_HOLD_Field is RP2040.Byte;
...
--  present
   ...
   subtype IC_TX_ABRT_SOURCE_TX_FLUSH_CNT_Field is RP2040.UInt9;
   ...
   type IC_SLV_DATA_NACK_ONLY_Register is record
      ...
      --  0x0
      NACK          : IC_SLV_DATA_NACK_ONLY_NACK_Field := RP2040.I2C.DISABLED;
      --  unspecified
   ...
   type IC_DMA_CR_Register is record
      --  Receive DMA Enable. This bit enables/disables the receive FIFO DMA
      --  channel. Reset value: 0x0
      RDMAE         : IC_DMA_CR_RDMAE_Field := RP2040.I2C.DISABLED;
      --  Transmit DMA Enable. This bit enables/disables the transmit FIFO DMA
      --  channel. Reset value: 0x0
      TDMAE         : IC_DMA_CR_TDMAE_Field := RP2040.I2C.DISABLED;
      --  unspecified
   ...
   subtype IC_DMA_TDLR_DMATDL_Field is RP2040.UInt4;
   ...
   subtype IC_DMA_RDLR_DMARDL_Field is RP2040.UInt4;
   ...
   subtype IC_SDA_SETUP_SDA_SETUP_Field is RP2040.Byte;
   ...
   subtype IC_FS_SPKLEN_IC_FS_SPKLEN_Field is RP2040.Byte;
   ...
   subtype IC_CLR_RESTART_DET_CLR_RESTART_DET_Field is RP2040.Bit;
   ...
   type IC_CLR_RESTART_DET_Register is record
      ...
      CLR_RESTART_DET : IC_CLR_RESTART_DET_CLR_RESTART_DET_Field;
      --  unspecified
      Reserved_1_31   : RP2040.UInt31;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype IC_COMP_PARAM_1_APB_DATA_WIDTH_Field is RP2040.UInt2;
   subtype IC_COMP_PARAM_1_MAX_SPEED_MODE_Field is RP2040.UInt2;
   subtype IC_COMP_PARAM_1_HC_COUNT_VALUES_Field is RP2040.Bit;
   subtype IC_COMP_PARAM_1_INTR_IO_Field is RP2040.Bit;
   subtype IC_COMP_PARAM_1_HAS_DMA_Field is RP2040.Bit;
   subtype IC_COMP_PARAM_1_ADD_ENCODED_PARAMS_Field is RP2040.Bit;
   subtype IC_COMP_PARAM_1_RX_BUFFER_DEPTH_Field is RP2040.Byte;
   subtype IC_COMP_PARAM_1_TX_BUFFER_DEPTH_Field is RP2040.Byte;
   ...
   type IC_COMP_PARAM_1_Register is record
      ...
      HC_COUNT_VALUES    : IC_COMP_PARAM_1_HC_COUNT_VALUES_Field;
      --  Read-only. COMBINED Interrupt outputs
      INTR_IO            : IC_COMP_PARAM_1_INTR_IO_Field;
      --  Read-only. DMA handshaking signals are enabled
      HAS_DMA            : IC_COMP_PARAM_1_HAS_DMA_Field;
      --  Read-only. Encoded parameters not visible
      ADD_ENCODED_PARAMS : IC_COMP_PARAM_1_ADD_ENCODED_PARAMS_Field;
   ...
   type I2C_Peripheral is record
      ...
      IC_COMP_VERSION       : aliased RP2040.UInt32;
      --  I2C Component Type Register
      IC_COMP_TYPE          : aliased RP2040.UInt32;
   end record
     with Volatile;
