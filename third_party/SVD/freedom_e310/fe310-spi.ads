...
package FE310.SPI is
   ...
   type SCKMODE_Register is record
      --  Serial Clock Phase
      PHA           : SCKMODE_CPHA := FE310.SPI.Val_0;
      --  Serial Clock Polarity
      POL           : SCKMODE_CPOL := FE310.SPI.Val_0;
      --  unspecified
   ...
   type CSMODE_Register is record
      MODE          : CSMODE_Chip_Select_Modes := FE310.SPI.Auto;
      --  unspecified
      Reserved_2_31 : FE310.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype DELAY0_CSSCK_Field is FE310.Byte;
   subtype DELAY0_SCKCS_Field is FE310.Byte;

   --  Delay Control Register 0.
   type DELAY0_Register is record
      CSSCK          : DELAY0_CSSCK_Field := 16#0#;
      --  unspecified
      Reserved_8_15  : FE310.Byte := 16#0#;
      SCKCS          : DELAY0_SCKCS_Field := 16#0#;
      --  unspecified
      Reserved_24_31 : FE310.Byte := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DELAY1_INTERCS_Field is FE310.Byte;
   subtype DELAY1_INTERXFR_Field is FE310.Byte;
   ...
   subtype FMT_LEN_Field is FE310.UInt4;

   --  Frame Format Register.
   type FMT_Register is record
      PROTO          : FMT_SPI_Protocol := FE310.SPI.Single;
      ENDIAN         : FMT_SPI_Endianness := FE310.SPI.Msb_First;
      DIR            : FMT_SPI_IO_Direction := FE310.SPI.Rx;
      --  unspecified
      Reserved_4_15  : FE310.UInt12 := 16#0#;
      LEN            : FMT_LEN_Field := 16#0#;
      --  unspecified
      Reserved_20_31 : FE310.UInt12 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype TXMARK_TXMARK_Field is FE310.UInt3;
   ...
   subtype RXMARK_RXMARK_Field is FE310.UInt3;
   ...
   subtype FCTRL_ENABLE_Field is FE310.Bit;

   --  SPI Flash Interface Control Register.
   type FCTRL_Register is record
      ENABLE        : FCTRL_ENABLE_Field := 16#0#;
      --  unspecified
      Reserved_1_31 : FE310.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FFMT_CMD_EN_Field is FE310.Bit;
   subtype FFMT_ADDR_LEN_Field is FE310.UInt3;
   subtype FFMT_PAD_CNT_Field is FE310.UInt4;
   subtype FFMT_CMD_PROTO_Field is FE310.UInt2;
   subtype FFMT_ADDR_PROTO_Field is FE310.UInt2;
   subtype FFMT_DATA_PROTO_Field is FE310.UInt2;
   subtype FFMT_CMD_CODE_Field is FE310.Byte;
   subtype FFMT_PAD_CODE_Field is FE310.Byte;

   --  SPI Flash Instruction Format Register.
   type FFMT_Register is record
      CMD_EN         : FFMT_CMD_EN_Field := 16#0#;
   ...
   type SPI_Peripheral is record
      ...
      CSID    : aliased FE310.UInt32;
      --  Chip Select Default Register.
      CSDEF   : aliased FE310.UInt32;
      --  Chip Select Mode Register.
