...
package FE310.OTP_Mem is
   ...
   subtype HFROSC_TRIM_VALUE_Field is FE310.UInt5;
   ...
   --  Code to jump to SPI-FLASH.
   type LAST_FENCE_Registers is array (0 .. 2) of FE310.UInt32
     with Volatile;
