...
--  This version of this package does not specify the Put_Image aspect for
--  type Super_String. This omission is needed for runtime configurations
--  that do not include package Ada.Strings.Text_Buffers.
